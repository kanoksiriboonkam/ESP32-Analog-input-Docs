...
ตอบเมื่อหมุนvolumeไปขวาvolumeจะลดลงมีค่าคือ0และเมื่อหมุนvolumeไปซ้ายvolumeจะมีค่าเพิ่มขึ้น

3. เปลี่ยนสาย jumper ไปยัง GPIO32 และแก้โปรแกรมให้สามารถรับรู้การหมุน volume ได้
ตอบเมื่อหมุนvolumeไปขวาvolumeจะลดลงมีค่าคือ0และเมื่อหมุนvolumeไปซ้ายvolumeจะมีค่าเพิ่มขึ้น
